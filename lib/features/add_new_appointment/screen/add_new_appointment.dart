      ...
      ontap: () async {
        ...
        if (_isVaildater) {
          ...
          bool value =
            ...
            double.parse(_samaySalonSettingModel!.platformFee),
            "PAP (Pay At Place)",
            bookingProvider.getAppointDuration!.inMinutes,
            bookingProvider.getAppointSelectedDate,
            bookingProvider.getAppointStartTime,
            bookingProvider.getAppointEndTime,
            _userNote.text.isEmpty ? " " : _userNote.text.trim(),
            widget.salonModel.id,
            _settingModel!.gstNo,
            _settingModel!.gstNo.length == 15
                ? bookingProvider.getCalGSTAmount
                : 0.0,
            bookingProvider.getDiscountInPer!,
            bookingProvider.getDiscountAmount!,
            bookingProvider
                .getExtraDiscountInPer!, // not calculate extr Discount
            bookingProvider.getExtraDiscountAmount!,
