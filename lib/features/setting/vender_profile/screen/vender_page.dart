...
//   // Make state/city non-nullable with empty defaults
//   String countryValue = "";
//   String stateValue = "";
//   String cityValue = "";
...
//     final chosen = await FilePicker.platform.pickFiles(type: FileType.image);
//     if (chosen != null) {
//       setState(() => selectedImage = chosen.files.single.bytes);
//       isImageChange = true;
//     }
//   }
...
//       if (info == null) throw Exception("No salon info");
...
//     final parts = s.split(' ');
//     final tp = parts[0].split(':').map(int.parse).toList();
...
//                         const SizedBox(height: 10),
//                         FormCustomTextField(
//                             controller: _email, title: "Email ID"),
//                         const SizedBox(height: 10),
//                         FormCustomTextField(
//                             controller: _mobile, title: "Mobile No"),
//                         const SizedBox(height: 10),
//                         FormCustomTextField(
//                             controller: _whatApp, title: "WhatApp No"),
//                         const SizedBox(height: 10),
//                         Text.rich(
//                           TextSpan(children: [
//                             TextSpan(
...
//                           items: _salonTypeOptions
//                               .map((v) =>
//                                   DropdownMenuItem(value: v, child: Text(v)))
//                               .toList(),
//                           onChanged: (v) =>
//                               setState(() => _selectedSalonType = v!),
//                           validator: (v) => v == null || v.isEmpty
//                               ? 'Please select a ${GlobalVariable.salon} type'
//                               : null,
//                         ),
//                         const SizedBox(height: 10),
//                         FormCustomTextField(
...
//                         const SizedBox(height: 10),
//                         FormCustomTextField(
//                             controller: _address, title: "Address", maxline: 2),
...
//                               stateDropdownLabel: stateValue.isNotEmpty
//                                   ? stateValue
//                                   : "Select State",
//                               cityDropdownLabel: cityValue.isNotEmpty
//                                   ? cityValue
//                                   : "Select City",
...
//                               );
//                               final ok = isImageChange
//                                   ? await appProvider.updateSalonInfoFirebase(
//                                       context, model, image: selectedImage)
//                                   : await appProvider.updateSalonInfoFirebase(
//                                       context, model);
...
//                               print(e);
//                               showMessage(
//                                   'Salon not updated or error occurred');
//                             }
//                           },
//                         ),
//                       ],
...
//           onOpenTimeSelected: (t) => setState(() => openTimeUpdate = t),
//           onCloseTimeSelected: (t) => setState(() => closeTimeUpdate = t),
//         ),
//       ],
//     );
//   }
...
class _SalonProfilePageState extends State<SalonProfilePage> {
  ...
  getData() async {
    ...
    try {
      ...
      // countryValue = appProvider.getSalonInformation.country;
